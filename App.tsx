...
const App: React.FC = () => {
  ...
  if (viewMode === ViewMode.HOME) {
    return (
      <div className="min-h-screen bg-[#0F0F0F] flex flex-col items-center justify-center p-6 space-y-12">
          ...
          <div className="space-y-8 pb-32">
            <div className="flex justify-between items-center mb-2">
               <div>
                 ...
                 <p className="text-[10px] text-gold uppercase tracking-widest mt-1 font-bold">{selectedCourse}</p>
               </div>
            ...
            <div className="bg-zinc-900/50 border border-zinc-800 rounded-3xl p-8 space-y-8">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-zinc-300 text-sm leading-relaxed">
                    Você receberá notificações automáticas 1 dia e 3 horas antes de cada aula programada para não perder nenhum conteúdo.
                  </p>
                </div>
              </div>
